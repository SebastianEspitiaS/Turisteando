...
class AfiliadoValidacionTest {
    ...
    public void ValidarCostoMensualidadFuncionaCorrectamente() {
        ...
        Boolean respuesta = Assertions
                .assertDoesNotThrow(() -> this.afilidadoValidacion.ValidarCostoMensualidad(costoMensualidadPrueba));
    ...
    public void ValidarCostoMensualidadFuncionaIncorrectamente() {
        ...
        Exception respuesta = Assertions.assertThrows(Exception.class,
                () -> this.afilidadoValidacion.ValidarCostoMensualidad(costoMensualidadPrueba));
