...
public class UsuarioValidacion {
    ...
    public boolean validarNombres(String nombres) throws Exception {
        ...
        } else if (!util.validarExpresionRegular(nombres, "^[a-zA-ZÀ-ÿ ]*[^0-9][a-zA-ZÀ-ÿ ]*$")) {
    ...
    public Boolean validarNit(String documento) throws Exception {
        if (documento.length() != 10) {
            throw new Exception(Mensaje.NUMERO_DOCUMENTO_INVALIDO.getMensaje());
        } else if (!util.validarExpresionRegular(documento, "^[0-9]+$")) {
