...
public class Turismo {
    ...
    private static Usuario obtenerDatosUsuario() {
        ...
        System.out.print("Ingrese su ubicacion (centro(1), sur(2), norte(3), otras(4)): ");
        usuario.setUbicacion(lea.nextInt());
        lea.nextLine();
        return usuario;
    }

    private static Local obtenerDatosLocal() {
    ...
    private static void imprimirDatos(Usuario usuario, Local local, Reserva reserva, Oferta oferta) {
        System.out.println("\n\n\u001B[35m**** Imprimir Datos ****\u001B[0m" + 
                           ...
                           "\nFecha de inicio de la oferta: " + util.muestraFeha(oferta.getFechaInicial()) + 
